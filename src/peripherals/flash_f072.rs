...
# [inline (always)]
pub const fn optr (self) -> crate :: common :: Reg < regs :: Optr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } # [doc = "Flash BORCR address register."]
# [inline (always)]
pub const fn borcr (self) -> crate :: common :: Reg < regs :: Borcr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x24usize) as _) } } # [doc = "desc WRPR."]
# [inline (always)]
...
fn default () -> Acr { Acr (0) } } # [doc = "Flash BORCR address register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Borcr (pub u32) ; impl Borcr { # [doc = "BOR enable."]
# [inline (always)]
pub const fn bor_en (& self) -> bool { let val = (self . 0 >> 5usize) & 0x01 ; val != 0 } # [doc = "BOR enable."]
# [inline (always)]
pub fn set_bor_en (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize) ; } # [doc = "BOR level."]
# [inline (always)]
pub const fn bor_lev (& self) -> u8 { let val = (self . 0 >> 13usize) & 0x07 ; val as u8 } # [doc = "BOR level."]
# [inline (always)]
pub fn set_bor_lev (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 13usize)) | (((val as u32) & 0x07) << 13usize) ; } } impl Default for Borcr { # [inline (always)]
fn default () -> Borcr { Borcr (0) } } # [doc = "desc CR."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Prgtpe { Prgtpe (0) } } # [doc = "desc SMERTPE."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
