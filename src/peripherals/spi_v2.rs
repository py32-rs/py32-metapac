...
# [inline (always)]
pub fn set_rxonly (& mut self , val : super :: vals :: Rxonly) { self . 0 = (self . 0 & ! (0x01 << 10usize)) | (((val . to_bits () as u32) & 0x01) << 10usize) ; } # [doc = "desc DDF."]
# [inline (always)]
pub const fn ddf (& self) -> bool { let val = (self . 0 >> 11usize) & 0x01 ; val != 0 } # [doc = "desc DDF."]
# [inline (always)]
pub fn set_ddf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } # [doc = "CRC transfer next."]
# [inline (always)]
...
# [inline (always)]
pub fn set_ssoe (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "desc CLRTXFIFO."]
# [inline (always)]
pub const fn clrtxfifo (& self) -> bool { let val = (self . 0 >> 4usize) & 0x01 ; val != 0 } # [doc = "desc CLRTXFIFO."]
# [inline (always)]
pub fn set_clrtxfifo (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize) ; } # [doc = "Error interrupt enable."]
# [inline (always)]
...
# [inline (always)]
pub fn set_txeie (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "FIFO reception threshold."]
# [inline (always)]
...
# [inline (always)]
pub fn set_i2smod (& mut self , val : super :: vals :: Ismod) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val . to_bits () as u32) & 0x01) << 11usize) ; } } impl Default for I2scfgr { # [inline (always)]
