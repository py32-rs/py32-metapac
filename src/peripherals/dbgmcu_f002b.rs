...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct ApbFz1 (pub u32) ; impl ApbFz1 { # [doc = "Debug LPTIM stopped when Core is halted."]
# [inline (always)]
...
# [inline (always)]
pub fn set_dbg_timer14_stop (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for ApbFz2 { # [inline (always)]
