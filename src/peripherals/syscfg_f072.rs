...
# [inline (always)]
pub const fn pfens (self) -> crate :: common :: Reg < regs :: Pfens , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1cusize) as _) } } # [doc = "I2C configuration register."]
# [inline (always)]
pub const fn eiic (self) -> crate :: common :: Reg < regs :: Eiic , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } } pub mod regs { # [doc = "desc CFGR1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr4 { Cfgr4 (0) } } # [doc = "I2C configuration register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Eiic (pub u32) ; impl Eiic { # [doc = "EIIC control signal for PA."]
# [inline (always)]
pub const fn pa_eiic (& self) -> u8 { let val = (self . 0 >> 0usize) & 0x03 ; val as u8 } # [doc = "EIIC control signal for PA."]
# [inline (always)]
pub fn set_pa_eiic (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 0usize)) | (((val as u32) & 0x03) << 0usize) ; } # [doc = "EIIC control signal for PB."]
# [inline (always)]
pub const fn pb_eiic (& self) -> u8 { let val = (self . 0 >> 8usize) & 0xff ; val as u8 } # [doc = "EIIC control signal for PB."]
# [inline (always)]
pub fn set_pb_eiic (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 8usize)) | (((val as u32) & 0xff) << 8usize) ; } # [doc = "EIIC control signal for PF."]
# [inline (always)]
pub const fn pf_eiic (& self) -> u8 { let val = (self . 0 >> 24usize) & 0x03 ; val as u8 } # [doc = "EIIC control signal for PF."]
# [inline (always)]
pub fn set_pf_eiic (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 24usize)) | (((val as u32) & 0x03) << 24usize) ; } } impl Default for Eiic { # [inline (always)]
fn default () -> Eiic { Eiic (0) } } # [doc = "desc PAENS."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn pf_ens (& self) -> u16 { let val = (self . 0 >> 0usize) & 0x03ff ; val as u16 } # [doc = "desc PF_ENS."]
# [inline (always)]
pub fn set_pf_ens (& mut self , val : u16) { self . 0 = (self . 0 & ! (0x03ff << 0usize)) | (((val as u32) & 0x03ff) << 0usize) ; } } impl Default for Pfens { # [inline (always)]
