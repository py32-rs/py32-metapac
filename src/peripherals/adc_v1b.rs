...
# [inline (always)]
pub fn set_calsmp (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 12usize)) | (((val as u32) & 0x03) << 12usize) ; } # [doc = "Calibration bypass."]
# [inline (always)]
pub const fn calbyp (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "Calibration bypass."]
# [inline (always)]
pub fn set_calbyp (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } # [doc = "Calibration factor selection."]
# [inline (always)]
pub const fn calset (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "Calibration factor selection."]
# [inline (always)]
pub fn set_calset (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } # [doc = "Offset calibration success flag."]
# [inline (always)]
pub const fn offsuc (& self) -> bool { let val = (self . 0 >> 29usize) & 0x01 ; val != 0 } # [doc = "Offset calibration success flag."]
# [inline (always)]
pub fn set_offsuc (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 29usize)) | (((val as u32) & 0x01) << 29usize) ; } # [doc = "Calibration success flag (0 = calibration failed)."]
# [inline (always)]
pub const fn calsuc (& self) -> bool { let val = (self . 0 >> 30usize) & 0x01 ; val != 0 } # [doc = "Calibration success flag (0 = calibration failed)."]
# [inline (always)]
pub fn set_calsuc (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 30usize)) | (((val as u32) & 0x01) << 30usize) ; } # [doc = "Calibration flag."]
# [inline (always)]
