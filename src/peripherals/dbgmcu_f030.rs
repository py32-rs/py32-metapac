...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct ApbFz1 (pub u32) ; impl ApbFz1 { # [doc = "Debug Timer 3 stopped when Core is halted."]
# [inline (always)]
pub const fn dbg_timer3_stop (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "Debug Timer 3 stopped when Core is halted."]
# [inline (always)]
pub fn set_dbg_timer3_stop (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Debug RTC stopped when Core is halted."]
# [inline (always)]
...
# [inline (always)]
pub fn set_dbg_iwdg_stop (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } # [doc = "Debug LPTIM stopped when Core is halted."]
# [inline (always)]
...
# [inline (always)]
pub fn set_dbg_timer14_stop (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } # [doc = "Debug Timer 16 stopped when Core is halted."]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Idcode (pub u32) ; impl Idcode { } impl Default for Idcode { # [inline (always)]
