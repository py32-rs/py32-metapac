...
# [inline (always)]
pub fn set_comp2rst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize) ; } } impl Default for Apbrstr2 { # [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ccipr (pub u32) ; impl Ccipr { # [doc = "COMP1 clock source selection."]
# [inline (always)]
pub const fn comp1sel (& self) -> bool { let val = (self . 0 >> 10usize) & 0x01 ; val != 0 } # [doc = "COMP1 clock source selection."]
# [inline (always)]
pub fn set_comp1sel (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize) ; } # [doc = "COMP2 clock source selection."]
# [inline (always)]
pub const fn comp2sel (& self) -> bool { let val = (self . 0 >> 11usize) & 0x01 ; val != 0 } # [doc = "COMP2 clock source selection."]
# [inline (always)]
pub fn set_comp2sel (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } # [doc = "LPTIM1 clock source selection."]
# [inline (always)]
...
# [inline (always)]
pub fn set_lse_driver (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 16usize)) | (((val as u32) & 0x03) << 16usize) ; } # [doc = "LSE startup time."]
# [inline (always)]
pub const fn lse_startup (& self) -> u8 { let val = (self . 0 >> 20usize) & 0x03 ; val as u8 } # [doc = "LSE startup time."]
# [inline (always)]
