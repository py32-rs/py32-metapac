...
pub const fn as_ptr (& self) -> * mut () { self . ptr as _ } # [doc = "Flash key register"]
# [inline (always)]
pub const fn keyr (self) -> crate :: common :: Reg < regs :: Keyr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x08usize) as _) } } # [doc = "Option byte key register"]
# [inline (always)]
pub const fn optkeyr (self) -> crate :: common :: Reg < regs :: Optkeyr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0cusize) as _) } } # [doc = "Status register"]
# [inline (always)]
...
# [inline (always)]
pub const fn ts3 (self) -> crate :: common :: Reg < regs :: Ts3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0110usize) as _) } } # [doc = "Flash ERTPE register"]
# [inline (always)]
pub const fn ertpe (self) -> crate :: common :: Reg < regs :: Ertpe , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0114usize) as _) } } # [doc = "Flash PRGTPE register"]
# [inline (always)]
...
# [inline (always)]
pub const fn pretpe (self) -> crate :: common :: Reg < regs :: Pretpe , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0120usize) as _) } } } pub mod regs { # [doc = "Flash control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Cr (pub u32) ; impl Cr { # [doc = "Page Program"]
# [inline (always)]
pub const fn pg (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Page Program"]
# [inline (always)]
...
# [inline (always)]
pub fn set_ser (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize) ; } # [doc = "Option bytes Programming Start"]
# [inline (always)]
pub const fn optstrt (& self) -> bool { let val = (self . 0 >> 17usize) & 0x01 ; val != 0 } # [doc = "Option bytes Programming Start"]
# [inline (always)]
pub fn set_optstrt (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize) ; } # [doc = "Programming Start"]
# [inline (always)]
pub const fn pgstrt (& self) -> bool { let val = (self . 0 >> 19usize) & 0x01 ; val != 0 } # [doc = "Programming Start"]
# [inline (always)]
...
# [inline (always)]
pub fn set_errie (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize) ; } # [doc = "Force the option bytes loading"]
# [inline (always)]
pub const fn obl_launch (& self) -> bool { let val = (self . 0 >> 27usize) & 0x01 ; val != 0 } # [doc = "Force the option bytes loading"]
# [inline (always)]
pub fn set_obl_launch (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 27usize)) | (((val as u32) & 0x01) << 27usize) ; } # [doc = "Option Lock"]
# [inline (always)]
pub const fn optlock (& self) -> bool { let val = (self . 0 >> 30usize) & 0x01 ; val != 0 } # [doc = "Option Lock"]
# [inline (always)]
pub fn set_optlock (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 30usize)) | (((val as u32) & 0x01) << 30usize) ; } # [doc = "Lock"]
# [inline (always)]
...
fn default () -> Cr { Cr (0) } } # [doc = "Flash ERTPE register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ertpe (pub u32) ; impl Ertpe { # [doc = "ERTPE value"]
# [inline (always)]
pub const fn ertpe (& self) -> u16 { let val = (self . 0 >> 0usize) & 0xffff ; val as u16 } # [doc = "ERTPE value"]
# [inline (always)]
pub fn set_ertpe (& mut self , val : u16) { self . 0 = (self . 0 & ! (0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize) ; } } impl Default for Ertpe { # [inline (always)]
fn default () -> Ertpe { Ertpe (0) } } # [doc = "Flash key register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Keyr (pub u32) ; impl Keyr { # [doc = "Flash CR key"]
# [inline (always)]
pub const fn key (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "Flash CR key"]
# [inline (always)]
...
fn default () -> Keyr { Keyr (0) } } # [doc = "Option byte key register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Optkeyr (pub u32) ; impl Optkeyr { # [doc = "Flash Option key"]
# [inline (always)]
pub const fn optkey (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "Flash Option key"]
# [inline (always)]
...
# [inline (always)]
pub fn set_rdp (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 0usize)) | (((val as u32) & 0xff) << 0usize) ; } # [doc = "BOR enable"]
# [inline (always)]
pub const fn bor_en (& self) -> bool { let val = (self . 0 >> 8usize) & 0x01 ; val != 0 } # [doc = "BOR enable"]
# [inline (always)]
pub fn set_bor_en (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize) ; } # [doc = "BOR level"]
# [inline (always)]
pub const fn bor_lev (& self) -> u8 { let val = (self . 0 >> 9usize) & 0x07 ; val as u8 } # [doc = "BOR level"]
# [inline (always)]
pub fn set_bor_lev (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x07 << 9usize)) | (((val as u32) & 0x07) << 9usize) ; } # [doc = "IWDG software enable"]
# [inline (always)]
pub const fn iwdg_sw (& self) -> bool { let val = (self . 0 >> 12usize) & 0x01 ; val != 0 } # [doc = "IWDG software enable"]
# [inline (always)]
pub fn set_iwdg_sw (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } # [doc = "NRST pin mode"]
# [inline (always)]
pub const fn nrst_mode (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "NRST pin mode"]
# [inline (always)]
pub fn set_nrst_mode (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } # [doc = "IWDG stop in debug"]
# [inline (always)]
pub const fn iwdg_stop (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "IWDG stop in debug"]
# [inline (always)]
...
fn default () -> Optr { Optr (0) } } # [doc = "Flash PRETPE register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Pretpe (pub u32) ; impl Pretpe { # [doc = "PRETPE value"]
# [inline (always)]
pub const fn pretpe (& self) -> u16 { let val = (self . 0 >> 0usize) & 0x3fff ; val as u16 } # [doc = "PRETPE value"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Prgtpe (pub u32) ; impl Prgtpe { # [doc = "PRGTPE value"]
# [inline (always)]
...
fn default () -> Sdkr { Sdkr (0) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_eop (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Write protection error"]
# [inline (always)]
pub const fn wrperr (& self) -> bool { let val = (self . 0 >> 4usize) & 0x01 ; val != 0 } # [doc = "Write protection error"]
# [inline (always)]
pub fn set_wrperr (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize) ; } # [doc = "Option and trimming bits loading validity error"]
# [inline (always)]
pub const fn optverr (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "Option and trimming bits loading validity error"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Stcr (pub u32) ; impl Stcr { # [doc = "Sleep enable"]
# [inline (always)]
pub const fn sleep_en (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Sleep enable"]
# [inline (always)]
pub fn set_sleep_en (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } } impl Default for Stcr { # [inline (always)]
fn default () -> Stcr { Stcr (0) } } # [doc = "Flash TPS3 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Tps3 (pub u32) ; impl Tps3 { # [doc = "TPS3 value"]
# [inline (always)]
pub const fn tps3 (& self) -> u16 { let val = (self . 0 >> 0usize) & 0x03ff ; val as u16 } # [doc = "TPS3 value"]
# [inline (always)]
pub fn set_tps3 (& mut self , val : u16) { self . 0 = (self . 0 & ! (0x03ff << 0usize)) | (((val as u32) & 0x03ff) << 0usize) ; } } impl Default for Tps3 { # [inline (always)]
fn default () -> Tps3 { Tps3 (0) } } # [doc = "Flash TS0 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ts0 (pub u32) ; impl Ts0 { # [doc = "TS0 value"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ts1 (pub u32) ; impl Ts1 { # [doc = "TS1 value"]
# [inline (always)]
pub const fn ts1 (& self) -> u8 { let val = (self . 0 >> 0usize) & 0xff ; val as u8 } # [doc = "TS1 value"]
# [inline (always)]
pub fn set_ts1 (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 0usize)) | (((val as u32) & 0xff) << 0usize) ; } } impl Default for Ts1 { # [inline (always)]
fn default () -> Ts1 { Ts1 (0) } } # [doc = "Flash TS2P register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ts2p (pub u32) ; impl Ts2p { # [doc = "TS2P value"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ts3 (pub u32) ; impl Ts3 { # [doc = "TS3 value"]
# [inline (always)]
pub const fn ts3 (& self) -> u8 { let val = (self . 0 >> 0usize) & 0xff ; val as u8 } # [doc = "TS3 value"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Wrpr (pub u32) ; impl Wrpr { # [doc = "Write protection address"]
# [inline (always)]
pub const fn wrp (& self) -> u16 { let val = (self . 0 >> 0usize) & 0xffff ; val as u16 } # [doc = "Write protection address"]
# [inline (always)]
