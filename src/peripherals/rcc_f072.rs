...
# [inline (always)]
pub fn set_adcen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize) ; } # [doc = "DBG clock enable."]
# [inline (always)]
pub const fn dbgen (& self) -> bool { let val = (self . 0 >> 10usize) & 0x01 ; val != 0 } # [doc = "DBG clock enable."]
# [inline (always)]
...
# [inline (always)]
pub fn set_adcrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize) ; } # [doc = "DBG reset."]
# [inline (always)]
pub const fn dbgrst (& self) -> bool { let val = (self . 0 >> 10usize) & 0x01 ; val != 0 } # [doc = "DBG reset."]
# [inline (always)]
...
# [inline (always)]
pub const fn adcdiv (& self) -> super :: vals :: Adcdiv { let val = (self . 0 >> 21usize) & 0x03 ; super :: vals :: Adcdiv :: from_bits (val as u8) } # [doc = "ADC Frequency Division."]
# [inline (always)]
pub fn set_adcdiv (& mut self , val : super :: vals :: Adcdiv) { self . 0 = (self . 0 & ! (0x03 << 21usize)) | (((val . to_bits () as u32) & 0x03) << 21usize) ; } # [doc = "PLL enable."]
# [inline (always)]
...
# [inline (always)]
pub fn set_lsirdy (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "NRST_FLTDIS oscillator ready."]
# [inline (always)]
pub const fn nrst_fltdis (& self) -> bool { let val = (self . 0 >> 8usize) & 0x01 ; val != 0 } # [doc = "NRST_FLTDIS oscillator ready."]
# [inline (always)]
pub fn set_nrst_fltdis (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize) ; } # [doc = "Remove reset flags."]
# [inline (always)]
...
SYSCLK = 0x01 , # [doc = "Reserved"]
RESERVED = 0x02 , # [doc = "HSI clock selected"]
