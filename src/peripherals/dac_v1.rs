...
# [inline (always)]
pub const fn tsel (& self , n : usize) -> super :: vals :: Tsel { assert ! (n < 2usize) ; let offs = 3usize + n * 16usize ; let val = (self . 0 >> offs) & 0x07 ; super :: vals :: Tsel :: from_bits (val as u8) } # [doc = "channel trigger selection"]
# [inline (always)]
pub fn set_tsel (& mut self , n : usize , val : super :: vals :: Tsel) { assert ! (n < 2usize) ; let offs = 3usize + n * 16usize ; self . 0 = (self . 0 & ! (0x07 << offs)) | (((val . to_bits () as u32) & 0x07) << offs) ; } # [doc = "channel noise/triangle wave generation enable"]
# [inline (always)]
...
pub enum Tsel { # [doc = "Timer 6 TRGO event"]
TIM6_TRGO = 0x0 , # [doc = "Timer 3 TRGO event"]
TIM3_TRGO = 0x01 , # [doc = "Timer 7 TRGO event"]
TIM7_TRGO = 0x02 , # [doc = "Timer 15 TRGO event"]
TIM15_TRGO = 0x03 , # [doc = "Timer 2 TRGO event"]
TIM2_TRGO = 0x04 , _RESERVED_5 = 0x05 , # [doc = "External interrupt line 9"]
EXTI9 = 0x06 , # [doc = "Software trigger"]
SOFTWARE = 0x07 , } impl Tsel { # [inline (always)]
pub const fn from_bits (val : u8) -> Tsel { unsafe { core :: mem :: transmute (val & 0x07) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Tsel { # [inline (always)]
fn from (val : u8) -> Tsel { Tsel :: from_bits (val) } } impl From < Tsel > for u8 { # [inline (always)]
fn from (val : Tsel) -> u8 { Tsel :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
