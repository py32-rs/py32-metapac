...
# [inline (always)]
pub const fn brr (self) -> crate :: common :: Reg < regs :: Brr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x28usize) as _) } } } pub mod regs { # [doc = "GPIO alternate function high. register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Afrh (pub u32) ; impl Afrh { # [doc = "Alternate function selection for port x. bit y (y = 8..15)."]
# [inline (always)]
pub const fn afsel (& self , n : usize) -> u8 { assert ! (n < 8usize) ; let offs = 0usize + n * 4usize ; let val = (self . 0 >> offs) & 0x0f ; val as u8 } # [doc = "Alternate function selection for port x. bit y (y = 8..15)."]
# [inline (always)]
pub fn set_afsel (& mut self , n : usize , val : u8) { assert ! (n < 8usize) ; let offs = 0usize + n * 4usize ; self . 0 = (self . 0 & ! (0x0f << offs)) | (((val as u32) & 0x0f) << offs) ; } } impl Default for Afrh { # [inline (always)]
fn default () -> Afrh { Afrh (0) } } # [doc = "GPIO alternate function low. register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Afrl (pub u32) ; impl Afrl { # [doc = "Alternate function selection for port x. bit y (y = 0..7)."]
# [inline (always)]
pub const fn afsel (& self , n : usize) -> u8 { assert ! (n < 8usize) ; let offs = 0usize + n * 4usize ; let val = (self . 0 >> offs) & 0x0f ; val as u8 } # [doc = "Alternate function selection for port x. bit y (y = 0..7)."]
# [inline (always)]
pub fn set_afsel (& mut self , n : usize , val : u8) { assert ! (n < 8usize) ; let offs = 0usize + n * 4usize ; self . 0 = (self . 0 & ! (0x0f << offs)) | (((val as u32) & 0x0f) << offs) ; } } impl Default for Afrl { # [inline (always)]
fn default () -> Afrl { Afrl (0) } } # [doc = "port bit reset register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Brr (pub u32) ; impl Brr { # [doc = "Port Reset bit."]
# [inline (always)]
pub const fn br (& self , n : usize) -> bool { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Port Reset bit."]
# [inline (always)]
...
# [inline (always)]
pub const fn id (& self , n : usize) -> bool { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Port input data (y =. 0..15)."]
# [inline (always)]
pub fn set_id (& mut self , n : usize , val : bool) { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Idr { # [inline (always)]
...
# [inline (always)]
pub const fn lck (& self , n : usize) -> bool { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Port x lock bit y (y=. 0..15)."]
# [inline (always)]
pub fn set_lck (& mut self , n : usize , val : bool) { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Port x lock bit y (y=. 0..15)."]
# [inline (always)]
pub const fn lckk (& self) -> bool { let val = (self . 0 >> 16usize) & 0x01 ; val != 0 } # [doc = "Port x lock bit y (y=. 0..15)."]
# [inline (always)]
...
# [inline (always)]
pub const fn mode (& self , n : usize) -> super :: vals :: Moder { assert ! (n < 16usize) ; let offs = 0usize + n * 2usize ; let val = (self . 0 >> offs) & 0x03 ; super :: vals :: Moder :: from_bits (val as u8) } # [doc = "Port x configuration bits (y =. 0..15)."]
# [inline (always)]
pub fn set_mode (& mut self , n : usize , val : super :: vals :: Moder) { assert ! (n < 16usize) ; let offs = 0usize + n * 2usize ; self . 0 = (self . 0 & ! (0x03 << offs)) | (((val . to_bits () as u32) & 0x03) << offs) ; } } impl Default for Moder { # [inline (always)]
fn default () -> Moder { Moder (0) } } # [doc = "GPIO port output data register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Odr (pub u32) ; impl Odr { # [doc = "Port output data (y =. 0..15)."]
# [inline (always)]
pub const fn od (& self , n : usize) -> bool { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Port output data (y =. 0..15)."]
# [inline (always)]
pub fn set_od (& mut self , n : usize , val : bool) { assert ! (n < 16usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Odr { # [inline (always)]
...
# [inline (always)]
pub const fn ospeed (& self , n : usize) -> super :: vals :: Ospeedr { assert ! (n < 16usize) ; let offs = 0usize + n * 2usize ; let val = (self . 0 >> offs) & 0x03 ; super :: vals :: Ospeedr :: from_bits (val as u8) } # [doc = "Port x configuration bits (y =. 0..15)."]
# [inline (always)]
pub fn set_ospeed (& mut self , n : usize , val : super :: vals :: Ospeedr) { assert ! (n < 16usize) ; let offs = 0usize + n * 2usize ; self . 0 = (self . 0 & ! (0x03 << offs)) | (((val . to_bits () as u32) & 0x03) << offs) ; } } impl Default for Ospeedr { # [inline (always)]
...
# [inline (always)]
pub const fn pupd (& self , n : usize) -> super :: vals :: Pupdr { assert ! (n < 16usize) ; let offs = 0usize + n * 2usize ; let val = (self . 0 >> offs) & 0x03 ; super :: vals :: Pupdr :: from_bits (val as u8) } # [doc = "Port x configuration bits (y =. 0..15)."]
# [inline (always)]
pub fn set_pupd (& mut self , n : usize , val : super :: vals :: Pupdr) { assert ! (n < 16usize) ; let offs = 0usize + n * 2usize ; self . 0 = (self . 0 & ! (0x03 << offs)) | (((val . to_bits () as u32) & 0x03) << offs) ; } } impl Default for Pupdr { # [inline (always)]
