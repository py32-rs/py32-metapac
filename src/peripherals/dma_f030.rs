...
# [inline (always)]
pub const fn st (self , n : usize) -> St { assert ! (n < 3usize) ; unsafe { St :: from_ptr (self . ptr . add (0x08usize + n * 20usize) as _) } } } # [doc = "Stream cluster: S?CR, S?NDTR, S?M0AR, S?PAR and S?MAR registers"]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn gif (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 0usize + ([0usize , 4usize , 8usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Channel 1 Global interrupt flag."]
# [inline (always)]
pub fn set_gif (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 0usize + ([0usize , 4usize , 8usize]
[n]
as usize) ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Channel x Half Transfer Complete. flag."]
# [inline (always)]
pub const fn htif (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 0usize + ([2usize , 6usize , 10usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Channel x Half Transfer Complete. flag."]
# [inline (always)]
pub fn set_htif (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 0usize + ([2usize , 6usize , 10usize]
[n]
as usize) ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Channel x Transfer Complete. flag."]
# [inline (always)]
pub const fn tcif (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 0usize + ([1usize , 5usize , 9usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Channel x Transfer Complete. flag."]
# [inline (always)]
pub fn set_tcif (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 0usize + ([1usize , 5usize , 9usize]
[n]
as usize) ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Channel x Transfer Error. flag."]
# [inline (always)]
pub const fn teif (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 0usize + ([3usize , 7usize , 11usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Channel x Transfer Error. flag."]
# [inline (always)]
pub fn set_teif (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 0usize + ([3usize , 7usize , 11usize]
[n]
