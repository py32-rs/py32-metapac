...
# [inline (always)]
pub const fn hsi_trimming (self , n : usize) -> crate :: common :: Reg < regs :: HsiTrimming , crate :: common :: R > { assert ! (n < 5usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0usize + n * 4usize) as _) } } # [doc = "Temperature sensor calibration value at 30°C."]
# [inline (always)]
pub const fn ts_cal_30c (self) -> crate :: common :: Reg < regs :: Tscal , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x14usize) as _) } } # [doc = "Temperature sensor calibration value at 85°C."]
# [inline (always)]
pub const fn ts_cal_85c (self) -> crate :: common :: Reg < regs :: Tscal , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x18usize) as _) } } # [doc = "FLASH configuration values. 4,8,16,22.12,24MHz."]
# [inline (always)]
pub const fn eppara (self , n : usize) -> Eppara { assert ! (n < 5usize) ; unsafe { Eppara :: from_ptr (self . ptr . add (0x1cusize + n * 20usize) as _) } } } # [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn tps3 (& self) -> u16 { let val = (self . 0 >> 13usize) & 0x07ff ; val as u16 } # [doc = "TPS3 value."]
# [inline (always)]
pub fn set_tps3 (& mut self , val : u16) { self . 0 = (self . 0 & ! (0x07ff << 13usize)) | (((val as u32) & 0x07ff) << 13usize) ; } } impl Default for Eppara1 { # [inline (always)]
